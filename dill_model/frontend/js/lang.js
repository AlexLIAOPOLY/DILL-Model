...
const LANGS = {
    'zh-CN': {
        ...
        param_desc_angle_a: '光强分布阶段：控制干涉条纹的真实周期距离（两个最低点间距，单位μm），周期小=条纹密集=空间频率高',
        ...
        // 参数名称翻译（包含单位）
        avg_intensity: '平均入射光强度 (I<sub>avg</sub>) <span class="unit-label">mW/cm²</span>',
        fringe_visibility: '干涉条纹可见度 (V)',
        spatial_freq: '空间频率 (K) <span class="unit-label">rad/μm</span>',
        dill_C: '光敏速率常数 (C) <span class="unit-label">cm²/mJ</span>',
        exposure_time: '曝光时间 (t<sub>exp</sub>) <span class="unit-label">s</span>',
        z_h: '胶厚 (z<sub>h</sub>) <span class="unit-label">μm</span>',
        T: '前烘温度 (T) <span class="unit-label">℃</span>',
        t_B: '前烘时间 (t<sub>B</sub>) <span class="unit-label">min</span>',
        I0: '初始光强 (I0) <span class="unit-label">mW/cm²</span>',
        M0: '初始PAC浓度 (M0)',
        t_exp_enhanced: '曝光时间 (t<sub>exp</sub>) <span class="unit-label">s</span>',
        car_acid_gen_efficiency: '光酸产生效率 (η)',
        car_diffusion_length: '扩散长度 (EPDL) <span class="unit-label">nm</span>',
        car_reaction_rate: '反应速率常数 (k) <span class="unit-label">s⁻¹</span>',
        ...
        thickness_dist: '形貌分布 (1D)',
        exposure_xy_dist: '曝光剂量分布 (2D) (X, Y平面)',
        thickness_xy_dist: '形貌分布 (2D) (X, Y平面)',
        x_position: 'X 位置 (μm)',
        y_position: 'Y 位置 (μm)',
        z_position: 'Z 位置 (μm)',
        ...
        // 以下是之前可能被删除的翻译
        kx_label: 'Kx (空间频率x) <span class="unit-label">rad/μm</span>',
        kx_description: 'x方向空间频率，单位：rad/μm，范围：0.1~10',
        ky_label: 'Ky (空间频率y) <span class="unit-label">rad/μm</span>',
        ky_description: 'y方向空间频率，单位：rad/μm，范围：0.1~100（必须大于0）',
        kz_label: 'Kz (空间频率z) <span class="unit-label">rad/μm</span>',
    ...
    param_desc_wavelength: 'Light Intensity Distribution Stage: Incident light wavelength, affects interference fringe spatial frequency, common values: 365nm(i-line), 405nm(h-line), 436nm(g-line)',
        ...
        // Parameter name translations (with units)
        avg_intensity: 'Average Incident Light Intensity (I<sub>avg</sub>) <span class="unit-label">mW/cm²</span>',
        fringe_visibility: 'Fringe Visibility (V)',
        spatial_freq: 'Spatial Frequency (K) <span class="unit-label">rad/μm</span>',
        dill_C: 'Photosensitivity Rate Constant (C) <span class="unit-label">cm²/mJ</span>',
        exposure_time: 'Exposure Time (t<sub>exp</sub>) <span class="unit-label">s</span>',
        z_h: 'Resist Thickness (z<sub>h</sub>) <span class="unit-label">μm</span>',
        T: 'Prebake Temperature (T) <span class="unit-label">℃</span>',
        t_B: 'Prebake Time (t<sub>B</sub>) <span class="unit-label">min</span>',
        I0: 'Initial Light Intensity (I0) <span class="unit-label">mW/cm²</span>',
        M0: 'Initial PAC Concentration (M0)',
        t_exp_enhanced: 'Exposure Time (t<sub>exp</sub>) <span class="unit-label">s</span>',
        car_acid_gen_efficiency: 'Photoacid Generation Efficiency (η)',
        car_diffusion_length: 'Diffusion Length (EPDL) <span class="unit-label">nm</span>',
        car_reaction_rate: 'Reaction Rate Constant (k) <span class="unit-label">s⁻¹</span>',
        ...
        // 以下是之前可能被删除的翻译
        kx_label: 'Kx (Spatial Frequency x) <span class="unit-label">rad/μm</span>',
        kx_description: 'Spatial frequency in x-direction, unit: rad/μm, range: 0.1~10',
        ky_label: 'Ky (Spatial Frequency y) <span class="unit-label">rad/μm</span>',
        ky_description: 'Spatial frequency in y-direction, unit: rad/μm, range: 0.1~100 (must >0)',
        kz_label: 'Kz (Spatial Frequency z) <span class="unit-label">rad/μm</span>',
